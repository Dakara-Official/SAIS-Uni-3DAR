...
# from .crystal_grid_dataset import CrystalGridDataset 不需要的库
# from .protein_grid_dataset import ProteinGridDataset 不需要的库
from .molecule_energy_grid_dataset import MoleculeEnergyGridDataset # 新增分子能量条件生成专属grid_dataset
...
class GridDataset(BaseWrapperDataset):
    def __init__(
        ...
        # self.crystal_grid_dataset = CrystalGridDataset(*dataset_args) 不需要
        # self.protein_grid_dataset = ProteinGridDataset(*dataset_args) 不需要
        self.molecule_energy_grid_dataset = MoleculeEnergyGridDataset(*dataset_args) # 新增分子能量条件生成专属grid_dataset
        ...
        # 新增分子能量条件生成专属grid_dataset
        self.datasets = {
            "molecule": self.base_grid_dataset,
            "molecule_energy": self.molecule_energy_grid_dataset,
        }
